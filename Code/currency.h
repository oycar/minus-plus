...
# // Add localized State Variables & Scalars
@define MPX_ARRAYS (SHARED_ARRAYS " ATO_Levy CGT_Discount Franking_Deficit_Offsets\
 GST_Rate LIC_Allowance LIC_Deduction Low_Income_Offset Middle_Income_Offset\
 Medicare_Levy Member_Liability Pension_Liability Reserve_Rate ")
